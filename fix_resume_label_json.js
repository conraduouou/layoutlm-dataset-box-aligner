...
function fixResumeLabelJson(filename) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            return { status: 201, message: `Fixing of ${filename}'s labels was successful! Check the 'annotations-fixed' folder!` };
        }
        catch (error) {
            return undefined;
        }
...
exports.default = fixResumeLabelJson;
