...
const fix_id_json_1 = __importDefault(require("./fix_id_json"));
        ...
        req.on('end', () => __awaiter(this, void 0, void 0, function* () {
            switch (req.url) {
                ...
                case '/fix-id-json':
                    try {
                        const requestBody = JSON.parse(body);
                        const result = yield (0, fix_id_json_1.default)(requestBody.filename);
                        console.log(result);
                        if (result)
                            response = result;
                        handleResponse(response, res);
                        ...
                        const filenames = filenamesResult.body.filenames;
                        for (const name of filenames) {
                            yield (0, fix_id_json_1.default)(name);
                        }
